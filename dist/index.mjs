...
// node_modules/start-testing/dist/context.js
var require_context = __commonJS({
  "node_modules/start-testing/dist/context.js"(exports) {
    "use strict";
    ...
    var Context3 = function() {
      function Context4(name, opts) {
        ...
        this.errors = [];
        this.subContexts = [];
        this.new = function(name2) {
          return new Context4(name2, _this.opts);
        };
        this.logger = opts.logger.new();
        this.performance = this.opts.performance || Date;
      }
      Context4.prototype.log = function() {
        var _a4;
        var message = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          message[_i] = arguments[_i];
        }
        (_a4 = this.logger).print.apply(_a4, message);
      };
      Context4.prototype.error = function(error) {
        this.failed = true;
        this.errors.push(error);
      };
      Context4.prototype.fatal = function(error) {
        throw new Error(error);
      };
      Context4.prototype.run = function(name, test) {
        return __awaiter(this, void 0, void 0, function() {
          var start, ctx, e_1, ms;
          return __generator(this, function(_a4) {
            switch (_a4.label) {
              case 0:
                start = this.performance.now();
                ctx = this.addCtx("".concat(this.name, " / ").concat(name));
                _a4.label = 1;
              case 1:
                _a4.trys.push([1, 3, 4, 5]);
                ctx.logger.info("TEST: ".concat(ctx.name, "..."));
                return [4, test(ctx)];
              case 2:
                _a4.sent();
                return [3, 5];
              ...
              case 4:
                if (ctx.failed) {
                  ...
                  ctx.errors.forEach(function(err) {
                    ctx.logger.error("ERROR: ".concat(err));
                  });
                  if (ctx.exception) {
                    ctx.logger.error("FATAL: ".concat(ctx.exception));
                    ctx.logger.print(ctx.exception.stack);
                  }
                } else {
                  ms = Math.ceil((this.performance.now() - start) * 1e3) / 1e3;
                  ctx.logger.success("PASSED! (".concat(ms, " ms)"));
                }
                ctx.logger.dump();
                return [7];
              case 5:
      ...
      Context4.prototype.addCtx = function(name, ctx) {
        if (ctx === void 0) {
          ctx = this.new(name);
        }
      ...
      Context4.prototype.numFailed = function() {
        return this.subContexts.reduce(function(count, ctx) {
          return count + ctx.numFailed();
        }, this.failed ? 1 : 0);
      };
      return Context4;
    }();
    exports.Context = Context3;
  }
});

// node_modules/start-testing/dist/logger.js
var require_logger = __commonJS({
  "node_modules/start-testing/dist/logger.js"(exports) {
    "use strict";
    ...
    var LogLevel;
    (function(LogLevel2) {
      LogLevel2[LogLevel2["DEFAULT"] = 0] = "DEFAULT";
    ...
    var Logger2 = function() {
      function Logger3() {
        ...
        this.print = function() {
          ...
          return _this.log.apply(_this, __spreadArray([LogLevel.DEFAULT], message, false));
        };
        this.info = function() {
          var message = [];
          for (var _i = 0; _i < arguments.length; _i++) {
          ...
          return _this.log.apply(_this, __spreadArray([LogLevel.INFO], message, false));
        };
        this.warn = function() {
          var message = [];
          for (var _i = 0; _i < arguments.length; _i++) {
          ...
          return _this.log.apply(_this, __spreadArray([LogLevel.WARN], message, false));
        };
        this.error = function() {
          var message = [];
          for (var _i = 0; _i < arguments.length; _i++) {
          ...
          return _this.log.apply(_this, __spreadArray([LogLevel.ERROR], message, false));
        };
        this.success = function() {
          ...
          return _this.log.apply(_this, __spreadArray([LogLevel.SUCCESS], message, false));
        };
      }
      Logger3.prototype.dump = function() {
        var _this = this;
        this.logs.forEach(function(entry) {
          console.log.apply(console, _this.format(entry));
        });
      };
      Logger3.prototype.log = function(level) {
        var message = [];
      ...
      Logger3.prototype.format = function(entry) {
...
// node_modules/start-testing/dist/runner.js
var require_runner = __commonJS({
  "node_modules/start-testing/dist/runner.js"(exports) {
    "use strict";
    ...
    var Runner = function(_super) {
      __extends(Runner2, _super);
      function Runner2() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      Runner2.runSuite = function(name, tests, opts) {
        if (opts === void 0) {
          opts = defaultOptions3;
        }
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a4) {
            return [2, new Runner2(name, opts).runSuite(tests)];
          });
        });
      };
      Runner2.prototype.runSuite = function(tests) {
        return __awaiter(this, void 0, void 0, function() {
          var _i, _a4, _b, name_1, test, numFailed;
          return __generator(this, function(_c) {
            switch (_c.label) {
              case 0:
                _i = 0, _a4 = Object.entries(tests);
                _c.label = 1;
              case 1:
                if (!(_i < _a4.length))
                  return [3, 4];
                _b = _a4[_i], name_1 = _b[0], test = _b[1];
                if (!(name_1.startsWith("test") && typeof test === "function"))
                  return [3, 3];
                return [4, this.run(name_1, test)];
              case 2:
                _c.sent();
                _c.label = 3;
              case 3:
              ...
              case 4:
                ...
                if (numFailed > 0) {
                  this.logger.warn("".concat(numFailed, " test failure").concat(numFailed > 1 ? "s" : ""));
                }
                this.logger.dump();
                return [2, numFailed];
            }
...
// node_modules/start-testing/dist/index.js
var require_dist = __commonJS({
  "node_modules/start-testing/dist/index.js"(exports) {
    "use strict";
...
// node_modules/start-testing/dist/extra/nodeLogger.js
var require_nodeLogger = __commonJS({
  "node_modules/start-testing/dist/extra/nodeLogger.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.NodeColorLogger = void 0;
    var testing4 = require_dist();
    var NodeColorLogger2 = function(_super) {
      __extends(NodeColorLogger3, _super);
      function NodeColorLogger3() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.new = function() {
          return new NodeColorLogger3();
        };
        return _this;
      }
      NodeColorLogger3.prototype.format = function(entry) {
        var code = NodeColorLogger3.colorCodes[entry.level];
        return ["\x1B[".concat(code, "m%s\x1B[0m"), entry.message.join(" ")];
      };
      NodeColorLogger3.colorCodes = [0, 36, 33, 35, 32];
      return NodeColorLogger3;
    }(testing4.Logger);
    exports.NodeColorLogger = NodeColorLogger2;
  }
});
...
// src/cloudflareContext.ts
var testing = __toESM(require_dist(), 1);
var CloudflareContext = class extends testing.Context {
  constructor() {
    super(...arguments);
    __publicField(this, "new", (name) => new CloudflareContext(name, this.opts));
  }
  toJSON() {
    return {
      name: this.name,
...
// src/cloudflareLogger.ts
var testing2 = __toESM(require_dist(), 1);
var CloudflareLogger = class extends testing2.Logger {
  constructor() {
    super(...arguments);
    __publicField(this, "new", () => new CloudflareLogger());
  }
  toJSON() {
    return {
      logs: this.logs
...
// src/cloudflareRunner.ts
var defaultOptions = {
  logger: new CloudflareLogger()
};
var CloudflareRunner = class extends CloudflareContext {
...
// src/localContext.ts
var testing3 = __toESM(require_dist(), 1);

// src/localLogger.ts
var import_nodeLogger = __toESM(require_nodeLogger(), 1);
var LocalLogger = class extends import_nodeLogger.NodeColorLogger {
  constructor() {
    super(...arguments);
    __publicField(this, "new", () => new LocalLogger());
  }
...
// src/localContext.ts
var LocalContext = class extends testing3.Context {
  constructor() {
    super(...arguments);
    __publicField(this, "new", (name) => new LocalContext(name, this.opts));
  }
  static fromJSON(data) {
    ...
    ctx.subContexts = data.subContexts.map((data2) => {
      return LocalContext.fromJSON(data2);
    });
    if (data.exception) {
...
var LocalRunner = class extends LocalContext {
  constructor(name, cloudflareRunner, opts = defaultOptions2) {
    super(name, opts);
